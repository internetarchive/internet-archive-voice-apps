...
function handler (app) {
  ...
  let repromptText = fallbackStrings.didntCatchThat + ' ' + intentStrings.welcome;
  ...
  let speechOutput = '<speak> <audio src="https://s3.amazonaws.com/gratefulerrorlogs/CrowdNoise.mp3" />' + greetingStrings.welcome.liveMusicCollection + ' ' + intentStrings.welcome + '</speak>';
  ...
  if (app.getLastSeen() !== null) {
    speechOutput = greetingStrings.welcomeBack + ' ' + intentStrings.welcome;
  }
