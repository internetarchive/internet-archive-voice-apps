  ...
  intents: {
    ...
    musicQuery: [{
      ...
      prompts: [{
        ...
        prompts: [
          'Ok, {{__resolvers.creator.title}} has played in {{coverage}} sometime <emphasis level="moderate">{{__resolvers.years-interval.suggestions}}</emphasis>. Do you have a particular year in mind?',
        ],
      }],
